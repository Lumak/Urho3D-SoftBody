											 ...
											 btIDebugDraw* idraw)
{
	...
	{
        // Urho3D: scale changed from 10 to 1
		static const btScalar	ascl=1;
        ...
        // Urho3D: added activation status color
		btIDebugDraw::DefaultColors defaultColors = idraw->getDefaultColors();
        btVector3 color(btScalar(0.4),btScalar(0.4),btScalar(0.4));
        switch(psb->getActivationState())
        {
        case  ACTIVE_TAG:
